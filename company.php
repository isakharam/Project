  ...
  <!-- Material Design Bootstrap -->
		...
		<body>
		   <div class="head">
			...
			<div class="text">
			<h1>COMPANY</h1>
			<p>We, the Ghoomlo team, established in 2019, taking a stride to give palce a value,</br>
			thereby adding more monetary aid to the people who suffers in these regions inspite of</br>
			having all the beauty of the nature.</p>
