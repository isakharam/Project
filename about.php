...
<div class="register">
			...
			<div class="text">
			<h1>ABOUT US</h1>
			<p>Founded by three, we provide the areal value to the less known<br>
				places, pure exotic and recreational for humans to get in touch with nature.<br>
				We are a part of the Ghoomlo Group, with over 3 employees, making<br>
				it one of the leading online travel agencies in the world.<br>
				With more than 1,000 regions, we&#39;ve built an extensive adventure<br>
				network to give our customers a fantastic choice of perk.</p>
			...
			<div class="container11">
				<div class="footer">
					...
					<div class="fot">
						...
						<a href="silo/login.php"><p>REGISTRATION</p></a>
