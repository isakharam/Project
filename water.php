<!DOCTYPE HTML>
  ...
  <!-- Material Design Bootstrap -->
		...
		<body>
			...
			<div class="tcon">
					<img src="img/wscover.jpg">
					<div class="tx">
						<center>
						<h1>WATER SPORTS</h1>
						<p>“If there is magic on this planet, then it is contained in water”</p></center>
					</div>		
			</div>
			<div class="adjust">
				<div class="b1">
